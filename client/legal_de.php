...
<p>Thorsten Hack<br/>Fuchsweg 103<br/>73230 Kirchheim/Teck</p>
<p>E-Mail: <span id="cloak113be28e54f2007e334d0b709a97b46e">Diese E-Mail-Adresse ist vor Spambots geschützt! Zur Anzeige muss JavaScript eingeschaltet sein!</span>
    <script type='text/javascript'>
        document.getElementById('cloak113be28e54f2007e334d0b709a97b46e').innerHTML = '';
        var prefix = '&#109;a' + 'i&#108;' + '&#116;o';
        var path = 'hr' + 'ef' + '=';
        var addy113be28e54f2007e334d0b709a97b46e = 'wiki&#98;lu&#102;f' + '&#64;';
        addy113be28e54f2007e334d0b709a97b46e = addy113be28e54f2007e334d0b709a97b46e + 't&#104;orsten' + 'h&#97;ck' + '&#46;' + 'd&#101;';
        document.getElementById('cloak113be28e54f2007e334d0b709a97b46e').innerHTML += '<a ' + path + '\'' + prefix + ':' + addy113be28e54f2007e334d0b709a97b46e + '\'>' + addy113be28e54f2007e334d0b709a97b46e + '<\/a>';
    </script>
</p>
...
<p>Thorsten Hack<br>Fuchsweg 103<br>73230 Kirchheim/Teck<br>Deutschland</p>
<p>E-Mail: <span id="cloak113be28e54f2007e334d0b709a97b46ef">Diese E-Mail-Adresse ist vor Spambots geschützt! Zur Anzeige muss JavaScript eingeschaltet sein!</span>
    <script type='text/javascript'>
        document.getElementById('cloak113be28e54f2007e334d0b709a97b46ef').innerHTML = '';
        var prefix = '&#109;a' + 'i&#108;' + '&#116;o';
        var path = 'hr' + 'ef' + '=';
        var addy113be28e54f2007e334d0b709a97b46e = 'wiki&#98;lu&#102;f' + '&#64;';
        addy113be28e54f2007e334d0b709a97b46e = addy113be28e54f2007e334d0b709a97b46e + 't&#104;orsten' + 'h&#97;ck' + '&#46;' + 'd&#101;';
        document.getElementById('cloak113be28e54f2007e334d0b709a97b46ef').innerHTML += '<a ' + path + '\'' + prefix + ':' + addy113be28e54f2007e334d0b709a97b46e + '\'>' + addy113be28e54f2007e334d0b709a97b46e + '<\/a>';
    </script>
</p>
...
<p>Aus technischen Gründen, insbesondere zur Gewährleistung eines sicheren und stabilen Internetauftritts,
    ...
    diesen sog. Server-Logfiles werden u.a. Typ und Version Ihres Internetbrowsers, das Betriebssystem, die
    Website, von der aus Sie auf unseren Internetauftritt gewechselt haben (Referrer URL), die Website(s)
    unseres Internetauftritts, die Sie besuchen, Datum und Uhrzeit des jeweiligen Zugriffs sowie die
...
<p>Die Daten werden spätestens nach sieben Tage wieder gelöscht, soweit keine weitere Aufbewahrung zu
    ...
    ganz oder teilweise von der Löschung ausgenommen.</p>
...
<p>Sollten Sie die Installation der Cookies verhindern oder einschränken, kann dies allerdings dazu führen,
    dass nicht sämtliche Funktionen unseres Internetauftritts vollumfänglich nutzbar sind.</p>

<h4>Nutzerbeiträge, Kommentare und Bewertungen</h4>
<p>Wir bieten Ihnen an, auf unseren Internetseiten Fragen, Antworten, Meinungen oder Bewertungen,
    nachfolgend nur „Beiträge genannt, zu veröffentlichen. Sofern Sie dieses Angebot in Anspruch nehmen,
    verarbeiten und veröffentlichen wir Ihren Beitrag, Datum und Uhrzeit der Einreichung sowie das von Ihnen
    ggf. genutzte Pseudonym.</p>
<p>Rechtsgrundlage hierbei ist Art. 6 Abs. 1 lit. a) DSGVO. Die Einwilligung können Sie gemäß Art. 7 Abs. 3
    DSGVO jederzeit mit Wirkung für die Zukunft widerrufen. Hierzu müssen Sie uns lediglich über Ihren
    Widerruf in Kenntnis setzen.</p>
<p>Darüber hinaus verarbeiten wir auch Ihre IP- und E-Mail-Adresse. Die IP-Adresse wird verarbeitet, weil
    wir ein berechtigtes Interesse daran haben, weitere Schritte einzuleiten oder zu unterstützen, sofern
    Ihr Beitrag in Rechte Dritter eingreift und/oder er sonst wie rechtswidrig erfolgt.</p>
<p>Rechtsgrundlage ist in diesem Fall Art. 6 Abs. 1 lit. f) DSGVO. Unser berechtigtes Interesse liegt in der
    ggf. notwendigen Rechtsverteidigung.</p>
...
<p>Um die Darstellung bestimmter Schriften in unserem Internetauftritt zu ermöglichen, wird bei Aufruf
    unseres Internetauftritts eine Verbindung zu dem Google-Server in den USA aufgebaut.</p>
<p>Rechtsgrundlage ist Art. 6 Abs. 1 lit. f) DSGVO. Unser berechtigtes Interesse liegt in der Optimierung
    und dem wirtschaftlichen Betrieb unseres Internetauftritts.</p>
<p>Durch die bei Aufruf unseres Internetauftritts hergestellte Verbindung zu Google kann Google ermitteln,
    von welcher Website Ihre Anfrage gesendet worden ist und an welche IP-Adresse die Darstellung der
    Schrift zu übermitteln ist.</p>
...
<p>weitere Informationen an und zwar insbesondere zu den Möglichkeiten der Unterbindung der
    Datennutzung.</p>
