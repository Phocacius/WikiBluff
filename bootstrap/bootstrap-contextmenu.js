...
!(function($) {
	...
	ContextMenu.prototype = {
		...
		,show: function(e) {
			...
			// unit sidebar
			if($(".span3").has(e.currentTarget).length > 0) {				
				editor.options.contextMenuId = parseInt($(e.currentTarget).parent().attr("data-id"));
				$(".span3 .sortable li>div").removeClass("contextMenuOpened");
				$(e.currentTarget).addClass("contextMenuOpened");
			}
			// widget list view
			else if($("#widget_list").has(e.currentTarget).length > 0) {				
				editor.options.widgetContextMenuId = parseInt($(e.currentTarget).attr("data-id"));
				$("#widget_list .sortable li").removeClass("contextMenuOpened");
				$(e.currentTarget).addClass("contextMenuOpened");
			}
		...
		,closemenu: function(e) {
			editor.options.contextMenuId = null;
			$(".span3 .sortable li>div").removeClass("contextMenuOpened");
			editor.options.widgetContextMenuId = null;
			$("#widget_list .sortable li").removeClass("contextMenuOpened");
